...
export const UpdateAvatarProfile = ({className}: UploadImageProps) => {
    ...
    return (<div  className={className}>
            ...
            {
              onDrag ?  <div className=" scale-75 bg-sky-700 shadow-xl  bg-blue transition-all duration-300 h-96">   <div className="mx-auto">
                <img src={selectedFile} alt=""/></div>

 </div> : <div className={"p-9 outline-dashed outline-2 -outline-offset-2"} >
