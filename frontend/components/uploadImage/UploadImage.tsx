...
export const UpdateAvatarProfile = ({ className, onSelectFile }: UploadImageProps) => {
          ...
          <div className={"p-9 outline-dashed outline-2 -outline-offset-2"}>
            <div className={"bg-gray-200 m-10 p-5"}>
              <label htmlFor="upload">
                <input id={'upload'} type={'file'} accept={'image/*'} height={100} width={100} className={' w-64 h-64 hidden'} onChange={(e) => handleInput(e)} />
                <svg
                  className="m-auto"
