    ...
    <div className={className}>
      <div className={"flex justify-center"}>
        <div>
          ...
          >
            {video.Title}
            <p>{video.Description + video.tag.map((t) => t.tag.name)}</p>
          </div>
          <div>
            <ProgressBar
              value={currentTime}
        ...
        <div
          className={
            " -ml-16 sm:-ml-0 my-28 px-4 [&>*]:bg-gray-100  [&>*]:rounded-full  grid place-content-start gap-y-6 justify-items-center  p-5"
          }
        >
