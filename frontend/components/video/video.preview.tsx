    ...
    <div className={className}>
      <div className={"sm:flex justify-center"}>
        <div>
          ...
          <div
            className={
              "bg-black text-amber-50 w-fit absolute -my-20  mx-4 opacity-70 p-2 rounded-xl"
            }
          >
            {video.Title}
        ...
        <div
          className={
            " my-12 px-4  grid place-content-start gap-y-6 justify-items-center  px-auto"
          }
        >
          <div>
            <svg
          ...
          <div
            className={
              "bg-gray-100 border-4 border-gray-400 my-24 rounded-3xl p-5"
            }
          >
            {video.tag.map((t) => (
              <p key={t.tag.id}>{t.tag.name}</p>
            ))}
          </div>
        </div>
      </div>
