...
import {SelectContent, SelectItem, SelectTrigger} from "@/components/ui/select";
 ...
 const PageRegistration = () => {
  ...
  return <div>
    ...
    <form action="" className={"space-y-5 border p-10 my-5 rounded-2xl"} onSubmit={handleSubmit(onSubmit)}>
      ...
      <select className={"block outline-0"} id="gender">
        ...
        <option value="woman" className={"p-7"}>Женщина</option>
      </select>
      ...
      <div className={"text-center"}>      <Button type={"submit"} className={"w-full text-center"}>Регистрация</Button>
      </div>
    </form>
  </div>
}
